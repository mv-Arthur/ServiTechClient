    ...
    <div className={classes.root}>
      <div className={classes.order}>
          ...
          {form.editMode.status ? (
            <div>
              ...
              >
                ...
                <MenuItem
                  disabled={
                    order?.status === "rejected" || order?.status === "resolved"
                  }
                  value={"job"}
                >
                  В работе
                ...
                <MenuItem
                  disabled={
                    order?.status === "job" || order?.status === "resolved"
                  }
                  value={"rejected"}
                >
                  Отклонен
        ...
        <div className={classes.fileContainer}>
          ...
          <Button onClick={() => handleDownload(orderId)}>Скачать</Button>
          {order?.status === "job" && (
            <div
              style={{
                display: "flex",
        ...
        {store.user.role !== "user" ? (
          <div className={classes.personal}>
            <div className={classes.userImgContainer}>
              <img
                src={`${API_URL}/uploads/${order?.customer.avatar}`}
                alt=""
              />
            </div>
          ...
          <div className={classes.personal}>
            <div className={classes.userImgContainer}>
              <img
                src={`${API_URL}/uploads/${order?.operator.avatar}`}
                alt=""
              />
            </div>
            <div className={classes.userInitialsContainer}>
